...
const mockEmergencyIssues: EmergencyIssue[] = [
  {
    id: '1',
    title: 'Truck Engine Overheating',
    description: 'Truck #TRK-001 reported engine temperature above normal limits during delivery route.',
    severity: 'CRITICAL',
    category: 'VEHICLE',
    status: 'ACTIVE',
    affectedEntities: [
      { type: 'truck', id: 'TRK-001', name: 'Truck TRK-001' },
      { type: 'shipment', id: 'SHP-12345', name: 'Package to Downtown' }
    ],
    createdAt: new Date(Date.now() - 30 * 60 * 1000).toISOString(), // 30 minutes ago
    estimatedResolution: new Date(Date.now() + 60 * 60 * 1000).toISOString() // 1 hour from now
  },
  {
    id: '2',
    title: 'Multiple Delivery Delays',
    description: 'Traffic incident causing delays for 3 trucks in the downtown area.',
    severity: 'HIGH',
    category: 'DELIVERY',
    status: 'ACKNOWLEDGED',
    affectedEntities: [
      { type: 'truck', id: 'TRK-002', name: 'Truck TRK-002' },
      { type: 'truck', id: 'TRK-003', name: 'Truck TRK-003' },
      { type: 'truck', id: 'TRK-004', name: 'Truck TRK-004' }
    ],
    createdAt: new Date(Date.now() - 90 * 60 * 1000).toISOString(), // 90 minutes ago
    acknowledgedAt: new Date(Date.now() - 60 * 60 * 1000).toISOString(),
    estimatedResolution: new Date(Date.now() + 120 * 60 * 1000).toISOString()
  },
  {
    id: '3',
    title: 'Database Connection Pool Exhausted',
    description: 'High load causing database connection pool to reach maximum capacity.',
    severity: 'HIGH',
    category: 'SYSTEM',
    status: 'RESOLVED',
    createdAt: new Date(Date.now() - 180 * 60 * 1000).toISOString(), // 3 hours ago
    acknowledgedAt: new Date(Date.now() - 150 * 60 * 1000).toISOString(),
