...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible button component with multiple variants and sizes, built with Radix UI primitives and CVA for styling.',
      },
    },
  },
  tags: ['autodocs'],
  argTypes: {
    ...
    asChild: {
      control: 'boolean',
      description: 'When true, the button will render as a child element using Radix Slot',
    },
    disabled: {
      control: 'boolean',
